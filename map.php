...
?></title>
    ...
    <body <?php body_class(); ?>>
        ...
        <div id="map_canvas" style="width: 100%; height: 100%; margin-top: 46px;"></div>
        <div id="map_route" style="width: 200px; height: 100%; margin-top: 46px; float: right;"></div>
        <script>
            $("#map_canvas").height($(window).height());
        </script>
        <div id="map_controller">
            <form action="javascript:null" onsubmit="geocode()"><label for="findplace">Tìm kiếm:</label> <input name="findplace" type="text" id="address"/><input type="button" value="Tìm" onclick="geocode()" id="submitbutton"></form>
        </div>
