...
function show_event_meta_box_frontend() {
    global $post;
    $start_date = get_post_meta($post->ID, 'start_date', true);
    $start_time = get_post_meta($post->ID, 'start_time', true);
    $end_date = get_post_meta($post->ID, 'end_date', true);
        ...
        function show_place_meta_box_frontend($post=null) {
            ...
            <form>
                ...
                <li><label for="pros">Ưu điểm <span class="required">*</span></label>
                    <textarea type="text" required="required" name="pros" id="pros" value=""><?php echo $pros; ?></textarea><div class="clear"></div>
                </li>
                <li><label for="cons">Nhược điểm <span class="required">*</span></label>
                    <textarea type="text" required="required" name="cons" id="cons" value="" ><?php echo $cons; ?></textarea><div class="clear"></div>

                </li>
                <li><label for="open">Giờ mở cửa <span class="required">*</span></label>
                    <input type="text" name="open" id="open" required="required" value="<?php echo $open; ?>" /><div class="clear"></div>

                </li>
                <li><label for="mainmenu">Sản phẩm chính</label>
                    <input type="text" name="mainmenu" id="mainmenu" value="<?php echo $menu; ?>" /><div class="clear"></div>
                </li>
                <li><label for="cost">Mức giá</label>
                    <input type="text" name="cost" id="cost" value="<?php echo $cost; ?>" /><div class="clear"></div>
                </li>
                <li><label for="website">Website</label>
                    <input type="text" name="website" id="website" value="<?php echo $website; ?>"/><div class="clear"></div>
                </li>
                <li><label for="phone">Số điện thoại</label>
                    <input type="text" name="phone" id="phone" value="<?php echo $phone; ?>" /><div class="clear"></div>
                </li>
                <li>
                    <label for="rating">Đánh giá</label>
                ...
                <?php if (current_user_can('edit_others_posts')) { ?>
                    <li><label for="verifed">Xác thực?</label>
                        <input type="checkbox" id="verified" name="verified" <?php checked($check, 'on'); ?> /><div class="clear"></div>
                    </li>
                    <?php
                }
            }
