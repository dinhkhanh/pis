            ...
            <div id="author-info">
                <header class="entry-header">
                    ...
                    <div id="author-description">
                        ...
                        <p><?php printf('%s &middot %s &middot %s', get_the_author_meta('gender', $curauth->ID) == 1?'Nam':'Nữ', get_the_author_meta('age', $curauth->ID), get_the_author_meta('user_address', $curauth->ID));?>
